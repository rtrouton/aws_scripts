This script configures disk and memory usage to be forwarded from an EC2 instance running RedHat Enterprise Linux 7.x to Cloudwatch. For more details, see the links below:
